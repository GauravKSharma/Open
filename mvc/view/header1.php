...
<meta name="description" content="Exam Professor is a web-based tool that allows you to create tests, quizzes, or exams easily. Create tests for education, training, certification, or blogging and sell access to them!">

<meta name="keywords" content="online test,test maker,quiz maker,create quizzes online,testing software,online training,multiple choice test maker,quiz generator,quizmaker,distance learning">
<meta name="author" content="Exam Professor">
...
<div id=123 style="height:30px;width:100%;margin-top: 8px;background-color:#383838 ;">
<div id=1234 style="height:30px;width:15%; float:left;background-color:#383838 ;"></div>
<div id=1234 style="height:30px;width:15%; float:left;background-color:#383838 ;">
<?php
					//session_start ();
					if (isset ( $_SESSION ['uname'] )) {?>
						 <strong style="color:white;"> Welcome &nbsp;&nbsp; </strong>  <em style="color:white;"><?php echo $_SESSION ['uname'];?></em><?php
					}
					?>
</div>
